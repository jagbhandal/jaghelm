...
const FONT_PRESETS = [
  {
    id: 'default',
    name: 'Default',
    desc: 'Outfit + DM Sans + JetBrains Mono',
    sample: "'Outfit', sans-serif",
  },
  { id: 'clean', name: 'Clean', desc: 'Inter + Fira Code', sample: "'Inter', sans-serif" },
  {
    id: 'rounded',
    name: 'Rounded',
    desc: 'Nunito + Source Code Pro',
    sample: "'Nunito', sans-serif",
  },
  { id: 'sharp', name: 'Sharp', desc: 'Rajdhani + Roboto Mono', sample: "'Rajdhani', sans-serif" },
  {
    id: 'system',
    name: 'System',
    desc: 'OS default fonts (fastest)',
    sample: 'system-ui, sans-serif',
  },
];
...
const SIZE_CONTROLS = [
  {
    ...
    desc: 'Gateway Services, Production, etc.',
    min: 14,
    max: 24,
    default: 17,
  },
  {
    ...
    desc: 'VM 103, Raspberry Pi 5, etc.',
    min: 10,
    max: 16,
    default: 12,
  },
  ...
  {
    key: 'metricValueSm',
    label: 'Metric Values (Small)',
    desc: 'RAM used/total, Disk, Uptime text',
    min: 14,
    max: 24,
    default: 18,
  },
  {
    key: 'metricLabel',
    label: 'Metric Labels',
    desc: 'CPU, RAM, DISK, UPTIME headings',
    min: 8,
    max: 14,
    default: 10,
  },
  {
    key: 'serviceName',
    label: 'Service Names',
    desc: 'Container names on service cards',
    min: 11,
    max: 18,
    default: 13,
  },
  {
    key: 'serviceStatValue',
    label: 'Service Stat Values',
    desc: '1.4%, 1235 MB on service cards',
    min: 11,
    max: 18,
    default: 13,
  },
  {
    key: 'serviceStatLabel',
    label: 'Service Stat Labels',
    desc: 'CPU, MEM, RX, TX on service cards',
    min: 8,
    max: 14,
    default: 10,
  },
    ...
    <div className="settings-section">
      <Card title="Font Family">
        <p className="settings-desc">
          Choose a font pairing for the dashboard. Each preset includes display, body, and monospace
          fonts.
        </p>
      ...
      <Card title="Font Sizes">
        <p className="settings-desc">
          Fine-tune the size of specific dashboard elements. Drag a slider or click Reset to restore
          defaults.
        </p>
        ...
        <div style={{ marginTop: 8, paddingTop: 16, borderTop: '1px solid var(--border-color)' }}>
          <button className="settings-btn-danger" onClick={resetSizes}>
