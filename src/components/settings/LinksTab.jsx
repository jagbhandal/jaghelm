...
export default function LinksTab({ config, update, setConfig }) {
  ...
  const updateLink = (group, index, field, value) => {
    // Immutable: clone only the edited element, share the rest.
    const groupLinks = (links[group] || []).map((link, i) =>
        ...
        >
                      ...
                      <div className="settings-row-spread">
                        <div className="settings-row" style={{ gap: 4 }}>
                          ...
                          <button
                            className="settings-btn-sm"
                            onClick={() => moveLink(group, i, 1)}
                            disabled={i === groupLinks.length - 1}
                            style={{ opacity: i === groupLinks.length - 1 ? 0.3 : 1 }}
                          >
                            ↓
                          </button>
                        </div>
                        <div className="settings-row">
                          ...
                          <button className="settings-btn-sm" onClick={() => setEditingLink(null)}>
                            Done
                          </button>
                        </div>
                      </div>
          ...
          {addingTo === group ? (
            ...
            >
              ...
              />
              <div className="settings-row">
                <button className="settings-btn-primary" onClick={() => addLink(group)}>
                  Add
                </button>
                <button
                  className="settings-btn-sm"
